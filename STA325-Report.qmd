...
-   Mean
    ...
    -   A medium/high initial turbulency is associated with a lower mean.
...
-   Variance
    ...
    -   A medium/high gravitational acceleration is associated with lower variance of the particle clustering distribution. This also intuitively makes sense as when there is extremely high gravity, everything will tend to stick together making a distribution with zero variance.

    -   Interestingly medium turbulence decreases the variance of the particle clustering distribution, while infinite turbulence also decreases the variance but not as much as compared to medium turbulence.
