...
ModelMetricsMoment1 %\>% kable(digits = 6, caption = "Mean") ModelMetricsMoment2 %\>% kable(digits = 2, caption = "Variance") ModelMetricsMoment3 %\>% kable(digits = 2, caption = "Skew") ModelMetricsMoment4 %\>% kable(digits = 2, caption = "Kurtosis")
