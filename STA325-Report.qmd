...
While cross-validation is a common technique to estimate the true test-error, we believed that it would be too computationally expensive to fit many different folds of all of the models we wish to predict. This is a shortcoming, and provides for future investigation.
